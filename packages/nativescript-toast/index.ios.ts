...
export class Toasty {
  ...
  setVariant(value: ToastVariant, customParams?: ToastVariantParams): void {
    if (customParams) {
      this._textColor = customParams.textColor;
      this._backgroundColor = customParams.backgroundColor;
    }
